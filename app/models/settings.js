...
var DEFAULT_CONFIGURATION_FILE = require('../config').DEFAULT_CONFIGURATION_FILE;
...
var setDefaultSettings = function setDefaultSettings(done) {
  ...
  fs.readFile(DEVICES_FILE, 'utf8', function onRead(err, data) {
    ...
    fs.writeFile(DEVICES_FILE, JSON.stringify(localData), 'utf8', null);
  });
  ...
  fs.readFile(CONFIGURATION_FILE, 'utf8', function onRead(err, data) {
    ...
    mac = localData.radio.mac;
  });

  fs.readFile(DEFAULT_CONFIGURATION_FILE, 'utf8', function onRead(err, data) {
    var defaultData;
    ...
    defaultData.radio.mac = mac;

    fs.writeFile(CONFIGURATION_FILE, JSON.stringify(defaultData), 'utf8', done);
  });
};
